...
<body id="listOfPatient">
	...
	<img src="<c:url value='/resources/img/logoo.png'/>" width="50"
		class="logo" /> <var>
		...
		<ul>
			...
			<li><a href="${pageContext.request.contextPath}/patient/add">Add
			...
			<c:forEach var="patient" items="${patients}">
				...
				<tr id="patientRow_${patient.patientId}">
					...
					<td><img class="actions_${patient.patientId}"
						...
						onClick="save(${patient.patientId})" style="display: none"
